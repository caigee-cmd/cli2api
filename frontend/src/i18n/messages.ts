...
export const messages: Record<Lang, Dict> = {
  en: {
    ...
    systemSettingsLead: 'Manage cross-provider routing, WorkBuddy check-in defaults, updates, SQLite protection, and the console API key.',
    ...
    editAccountHint: 'Change the display name, concurrency, routing priority, and WorkBuddy check-in time.',
  ...
  zh: {
    ...
    systemSettingsLead: '管理跨 Provider 路由、WorkBuddy 签到默认时间、系统更新、SQLite 保护和控制台管理员密钥。',
    ...
    editAccountHint: '修改显示名称、并发、调度优先级，以及 WorkBuddy 签到时间。',
