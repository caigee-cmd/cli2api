...
export const messages: Record<Lang, Dict> = {
  en: {
    ...
    accountTypeCodexGlobal: 'Codex',
    accountTypeCodexGlobalHint: 'OpenAI Codex (ChatGPT subscription) via browser OAuth or imported credential',
  ...
  zh: {
    ...
    accountTypeCodexGlobal: 'Codex',
    accountTypeCodexGlobalHint: 'OpenAI Codex（ChatGPT 订阅）：浏览器 OAuth 或导入凭证',
