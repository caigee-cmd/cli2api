...
export const messages: Record<Lang, Dict> = {
  en: {
    ...
    crossProviderModelPoolHint: 'Bare model IDs can be routed across matching Qoder, WorkBuddy, and Trae accounts. Provider-prefixed IDs still pin one provider.',
  ...
  zh: {
    ...
    crossProviderModelPoolHint: '开启后，不带 Provider 前缀的模型 ID 可以在匹配的 Qoder、WorkBuddy 和 Trae 账号之间调度；带前缀的 ID 仍固定到指定 Provider。',
