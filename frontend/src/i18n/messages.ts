...
export const messages: Record<Lang, Dict> = {
  en: {
    ...
    updatePreparingHint: 'Preparing the update: checking the release, draining active requests, and creating a SQLite backup.',
    ...
    updateState_draining: 'Draining requests',
  ...
  zh: {
    ...
    updatePreparingHint: '正在准备更新：检查版本、等待在途请求结束，并创建 SQLite 快照。',
