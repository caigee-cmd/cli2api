...
export const messages: Record<Lang, Dict> = {
  en: {
    ...
    updatePreparingImageHint: 'The host updater is pulling the new image. The running service stays on the current version until you confirm the restart.',
  ...
  zh: {
    ...
    updatePreparingImageHint: '宿主机更新器正在拉取新镜像。当前服务仍运行旧版本，确认重启后才会切换。',
