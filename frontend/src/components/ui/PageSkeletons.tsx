...
export function AccountCardSkeleton() {
  return (
    <article className="app-panel-flat overflow-hidden rounded-lg">
...
export function AccessPageSkeleton() {
  return (
    <div className="space-y-6" aria-label="Loading access settings">
      ...
      <section className="app-panel grid min-h-[620px] overflow-hidden rounded-lg xl:grid-cols-[minmax(440px,.92fr)_minmax(0,1.08fr)]"><div className="space-y-6 border-b border-[var(--app-line)] p-7 xl:border-r xl:border-b-0"><div className="flex items-center gap-3"><SkeletonBlock className="size-9" /><div className="space-y-2"><SkeletonBlock className="h-4 w-32" /><SkeletonBlock className="h-3 w-28" /></div></div><div className="grid gap-5 sm:grid-cols-2"><div className="space-y-2"><SkeletonBlock className="h-4 w-16" /><SkeletonBlock className="h-10 w-full" /></div><div className="space-y-2"><SkeletonBlock className="h-4 w-16" /><SkeletonBlock className="h-10 w-full" /></div></div><SkeletonBlock className="h-56 w-full" /><SkeletonBlock className="h-12 w-full" /></div><div className="space-y-4 bg-[var(--app-code)]/45 p-6"><div className="flex justify-between"><div className="space-y-2"><SkeletonBlock className="h-4 w-32" /><SkeletonBlock className="h-3 w-44" /></div><SkeletonBlock className="h-6 w-20" /></div><SkeletonBlock className="mt-10 h-3 w-32" /><SkeletonBlock className="h-3 w-full" /><SkeletonBlock className="h-3 w-[86%]" /></div></section>
