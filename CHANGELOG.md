...
Open-source hygiene for a stranger clone:
...
First public Qoder-first tree: OpenAI-compatible proxy, hot WASM worker, React console, Docker Compose on loopback.
